...
JOIN intervienen i ON e.CodEmpleado=i.CodEmpleado WHERE IdReparacion='".$_GET['idrep']."';";
...
JOIN recambios rec ON rec.IdRecambio=inc.IdRecambio WHERE r.IdReparacion='".$_GET['idrep']."';";
